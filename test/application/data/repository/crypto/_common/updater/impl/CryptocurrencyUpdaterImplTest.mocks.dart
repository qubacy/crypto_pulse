...
class _FakeDotEnv_1 extends _i1.SmartFake implements _i3.DotEnv {
  _FakeDotEnv_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockRemoteCryptoHttpRestDataSource extends _i1.Mock
    implements _i4.RemoteCryptoHttpRestDataSource {
  ...
  @override
  _i5.Future<List<_i6.RemoteHttpRestCrypto>> getCryptocurrencies(int? count) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCryptocurrencies,
          [count],
        ),
        returnValue: _i5.Future<List<_i6.RemoteHttpRestCrypto>>.value(
            <_i6.RemoteHttpRestCrypto>[]),
      ) as _i5.Future<List<_i6.RemoteHttpRestCrypto>>);
}
...
class MockCryptocurrencyUpdaterCallback extends _i1.Mock
    implements _i7.CryptocurrencyUpdaterCallback {
  ...
  void onCryptocurrenciesGotten(
    int? count,
    List<_i6.RemoteHttpRestCrypto>? cryptocurrencies,
  ) =>
      super.noSuchMethod(
        Invocation.method(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHttpContext extends _i1.Mock implements _i8.HttpContext {
  MockHttpContext() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.DotEnv get dotEnv => (super.noSuchMethod(
        Invocation.getter(#dotEnv),
        returnValue: _FakeDotEnv_1(
          this,
          Invocation.getter(#dotEnv),
        ),
      ) as _i3.DotEnv);
  ...
  @override
  set dotEnv(_i3.DotEnv? _dotEnv) => super.noSuchMethod(
        Invocation.setter(
          #dotEnv,
          _dotEnv,
        ),
  ...
  @override
  _i5.Future<String> loadUri() => (super.noSuchMethod(
        Invocation.method(
          #loadUri,
          [],
        ),
...
class MockLocalTokenEnvironmentDataSource extends _i1.Mock
    implements _i10.LocalTokenEnvironmentDataSource {
  ...
  @override
  _i5.Future<String> loadToken() => (super.noSuchMethod(
        Invocation.method(
          #loadToken,
          [],
        ),
...
/// A class which mocks [CryptocurrencyUpdaterGraphInitializer].
///
/// See the documentation for Mockito's code generation for more information.
class MockCryptocurrencyUpdaterGraphInitializer extends _i1.Mock
    implements _i11.CryptocurrencyUpdaterGraphInitializer {
  MockCryptocurrencyUpdaterGraphInitializer() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> initGraph(List<dynamic>? args) => (super.noSuchMethod(
        Invocation.method(
          #initGraph,
          [args],
        ),
